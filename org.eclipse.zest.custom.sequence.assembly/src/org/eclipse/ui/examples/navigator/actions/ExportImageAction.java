...
public class ExportImageAction extends Action {
	...
	public ExportImageAction(UMLSequenceViewer viewer) {
		this.viewer = viewer;
	}
	/*
	 * (non-Javadoc)
	...
	@Override
	public void run() {
		//IViewPart part = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(JavaThreadSequenceView.VIEW_ID);
